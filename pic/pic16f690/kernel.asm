;
; Stack-based integer math and I/O for PIC 8-Bit Processors 
;
; Copyright (c) 2011 James Beau Wilkinson
;
; Licensed under the GNU General Public License ("Greater GPL")
;
; This is the version for the prior generation, e.g. PIC 16F690.
;
...
#include "hloe.inc"
 ...
 GLOBAL alt_fsr,hloe3,savesp,savesp2 ;second stack pointer (moves)
...
parm:
 ...
 subwf hloe2,w
 movwf FSR 
 movfw INDF ;After this, retval is in W
 ;Save Retval in mkarg1
 movwf hloe1 
 ;Fix FSR then push ret. val
 movf savesp2,w 
 movwf FSR ;restore user stack ptr...\n",target
 clrf savesp2
 decf FSR,f ; Account for earlier POP
